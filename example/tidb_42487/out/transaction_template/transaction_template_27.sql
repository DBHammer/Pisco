start transaction;
select `pkAttr0`, `pkAttr1`, `pkAttr2`, `pkAttr3`, `coAttr0_0`, `coAttr0_1` from `table0` where ( `pkAttr0`  =  ?  ) or ( `pkAttr1`  =  ?  ) and ( `pkAttr2`  =  ?  ) or ( `pkAttr3`  =  ?  ) order by `pkAttr0`, `pkAttr1`, `pkAttr2`, `pkAttr3` ;
